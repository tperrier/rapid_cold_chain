...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Equitment.label'
        db.add_column(u'dhis2_equitment', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contact.email'
        db.add_column(u'dhis2_contact', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Equitment.label'
        db.delete_column(u'dhis2_equitment', 'label')

        # Deleting field 'Contact.email'
        db.delete_column(u'dhis2_contact', 'email')
