...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.connection'
        db.add_column(u'dhis2_contact', 'connection',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='dhis2_contact', unique=True, null=True, to=orm['rapidsms.Connection']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Contact.connection'
        db.delete_column(u'dhis2_contact', 'connection_id')
